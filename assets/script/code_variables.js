...
Code.runJS = function() {
    ...
    switch (slideNo) {
        case 2:
            if (new String(code).valueOf().trim() == new String("window.alert('elma');").valueOf()) {
                $.fancybox.open("Tebrikler!! Başarıyla elma değişkenini oluşturdun şimdi 4. aşamaya geçebiliriz.", {
                    autoSize: false,
                    width: "500",
                    height: "auto",
                    closeBtn: true,
                    afterClose: function(){
                      //Buradan setHeader(3,2)'yi çağırsak iyiydi.'
                      console.log("true");
                    }
                });
            }else{
             $.fancybox.open("Sanırım eksik yada yanlış olan bir şeyler var. Komut bloklarını tekrar gözden geçirmeye ne dersin?", {
                    autoSize: false,
                    width: "500",
                    height: "auto",
                    closeBtn: true
        ...
        editedCode = code.replace(/(\r\n|\n|\r)/gm,"");
            if (new String(editedCode).valueOf().trim() == new String("var degisken;degisken = 3;window.alert(degisken);").valueOf().trim()) {
                 $.fancybox.open("Tebrikler!! Başarıyla 3 değişkenini oluşturdun şimdi 7. aşamaya geçebiliriz.", {
                    autoSize: false,
                    width: "500",
                    height: "auto",
                    closeBtn: true,
        ...
        case 6:
        editedCode = code.replace(/(\r\n|\n|\r)/gm,"");
            if (new String(editedCode).valueOf().trim() == new String("var sayi1;var sayi2;sayi1 = 4;sayi2 = 5;window.alert(sayi1 + sayi2);").valueOf().trim()) {
                 $.fancybox.open("Tebrikler!! Başarıyla iki farklı değişken oluşturup onlara veri ekleyebildin.", {
                    autoSize: false,
                    width: "500",
                    height: "auto",
                    closeBtn: true,
