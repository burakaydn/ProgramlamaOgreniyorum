...
switch (slideNo) {
        case 1:
        editedCode = code.trim().replace(/(\r\n|\n|\r)/gm,"");
        console.log(editedCode);
        console.log(new String(editedCode).valueOf().trim());
            if (new String(editedCode).valueOf().trim() == new String("for (var count = 0; count < 3; count++) {  checkTimeout();  window.alert('merhaba');}").valueOf()) {
                $.fancybox.open("Tebrikler!! Başarıyla ekrana 3 kez merhaba yazdırmayı başardın. Şimdi 2. aşamaya geçebiliriz.", {
                    autoSize: false,
                    width: "500",
                    height: "auto",
                    closeBtn: true,
        ...
        console.log(editedCode);
        console.log(new String(editedCode).valueOf().trim());
            if (new String(editedCode).valueOf().trim() == new String("for (var count = 0; count < 5; count++) {  checkTimeout();  window.alert('merhaba');} ").valueOf().trim()) {
                 $.fancybox.open("Tebrikler!! Başarıyla bir sayı oluşturarak döngüyü kontrol etmeyi başardın.", {
                    autoSize: false,
                    width: "500",
                    height: "auto",
                    closeBtn: true,
