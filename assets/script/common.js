...
BlocklyApps.hideDialog = function(opt_animate) {
  ...
  // while ($('#div-info-box').firstChild) {
    // var content = $('#div-info-box').firstChild;
    // content.className += ' dialogHiddenContent';
    // document.body.appendChild(content);
  // }
};
...
BlocklyApps.importPrettify = function() {
  ...
  link.setAttribute('href', './assets/style/prettify.css');
  document.head.appendChild(link);
  var script = document.createElement('script');
  script.setAttribute('type', 'text/javascript');
  script.setAttribute('src', './assets/script/prettify.js');
