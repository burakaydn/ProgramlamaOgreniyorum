...
Blockly.Trashcan.prototype.BODY_URL_ = "./assets/image/trashbody.png";
Blockly.Trashcan.prototype.LID_URL_ = "./assets/image/trashlid.png";
    ...
    if (b.length) {
        ...
        for (var c = 0, d = [Blockly.ContextMenu.svgBackground, Blockly.ContextMenu.svgShadow], e = 0, f; f = b[e]; e++) {
            ...
            Blockly.bindEvent_(g, "mousedown", null,
                Blockly.noEvent);
            f.enabled ? (f = function(a) {
                return function() {
                    Blockly.doCommand(a)
                }
            }(f.callback), Blockly.bindEvent_(g, "mouseup", null, f), Blockly.bindEvent_(g, "mouseup", null, Blockly.ContextMenu.hide)) : g.setAttribute("class", "blocklyMenuDivDisabled");
            c = Math.max(c, k.getComputedTextLength())
        }
        c += 2 * Blockly.ContextMenu.X_PADDING;
        for (e = 0; e < d.length; e++) d[e].setAttribute("width", c);
        if (Blockly.RTL)
            for (e = 0; g = Blockly.ContextMenu.svgOptions.childNodes[e]; e++) k = g.lastChild, k.setAttribute("text-anchor", "end"), k.setAttribute("x",
                c - Blockly.ContextMenu.X_PADDING);
        ...
        g = Blockly.svgSize();
        d + e.height > g.height && (d -= e.height - 10);
        Blockly.RTL ? 0 >= c - e.width ? c++ : c -= e.width : c + e.width > g.width ? c -= e.width : c++;
...
Blockly.Block.prototype.dispose = function(a, b, c) {
    ...
    for (a = 0; a <
        b.length; a++) c = b[a], c.targetConnection && c.disconnect(), b[a].dispose();
...
Blockly.Block.prototype.interpolateMsg = function(a, b) {
    ...
    f.length &&
        (k = this.appendDummyInput().setAlign(d), f.forEach(c, k));
...
Blockly.Flyout.prototype.reflow = function() {
    ...
    if (this.width_ != a) {
        ...
        //Toolbox first header set size
        var toolboxHeaderFirst = document.getElementById('div-blockly-header-first');
        
        if(toolboxHeaderFirst != null)
          toolboxHeaderFirst.style.width = a + 'px';
        //Toolbox first header set size
...
var rtclient = {
    ...
    getParams: function() {
        ...
        if (b)
            for (var b = b.slice(1).split("&"), c = 0; c < b.length; c++) {
                var d = b[c].split("=");
                a[d[0]] = unescape(d[1])
            }
        if (b = window.location.search)
            for (b = b.slice(1).split("&"), c = 0; c < b.length; c++) d = b[c].split("="), a[d[0]] = unescape(d[1]);
        //console.log(a);
        return a
    }
};
...
rtclient.Authorizer.prototype.authorize = function(a) {
    ...
    gapi.auth.authorize({
        client_id: b,
        scope: [rtclient.INSTALL_SCOPE, rtclient.FILE_SCOPE,
...
rtclient.createRealtimeFile = function(a, b, c) {
...
rtclient.RealtimeLoader.prototype.createNewFileAndRedirect = function() {
    var a = this;
    rtclient.createRealtimeFile(this.defaultTitle, this.newFileMimeType, function(b) {
...
Blockly.Css.CONTENT = [".blocklySvg {", "  background-color: #fff;", "  border: 1px solid #ddd;", "}", ".blocklyWidgetDiv {", "  position: absolute;", "  display: none;", "  z-index: 999;", "}", ".blocklyDraggable {", "  /* Hotspot coordinates are baked into the CUR file, but they are still", "     required in the CSS due to a Chrome bug.", "     http://code.google.com/p/chromium/issues/detail?id=1446 */", "  cursor: url(./assets/image/handopen.cur) 8 5, auto;", "}", ".blocklyResizeSE {", "  fill: #aaa;", "  cursor: se-resize;",
    ...
    "}", ".blocklyTreeRoot {", "  padding: 4px 0;", "}", ".blocklyTreeRoot:focus {", "  outline: none;", "}", ".blocklyTreeRow {", "  line-height: 22px;", "  height: 22px;", "  padding-right: 1em;", "  white-space: nowrap;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', "  padding-right: 0;", "  padding-left: 1em !important;", "}", ".blocklyTreeRow:hover {", "  background-color: #e4e4e4;", "}", ".blocklyTreeIcon {", "  height: 16px;", "  width: 16px;", "  vertical-align: middle;", "  background-image: url(/assets/image/tree.png);",
...
Blockly.init_ = function() {
    ...
    Blockly.loadAudio_(["./assets/media/click.mp3", "./assets/media/click.wav", "./assets/media/click.ogg"],
        "click");
    Blockly.loadAudio_(["./assets/media/delete.mp3", "./assets/media/delete.ogg", "./assets/media/delete.wav"], "delete")
};
// Copyright 2012 Google Inc.  Apache License 2.0
Blockly.utils = {};
...
Blockly.onMouseDown_ = function(a) {
    ...
    Blockly.isRightButton(a) ? Blockly.ContextMenu && Blockly.showContextMenu_(Blockly.mouseToSvg(a)) : (Blockly.readOnly || b) && Blockly.mainWorkspace.scrollbar && (Blockly.mainWorkspace.dragMode = !0, Blockly.mainWorkspace.startDragMouseX = a.clientX, Blockly.mainWorkspace.startDragMouseY =
        a.clientY, Blockly.mainWorkspace.startDragMetrics = Blockly.mainWorkspace.getMetrics(), Blockly.mainWorkspace.startScrollX = Blockly.mainWorkspace.scrollX, Blockly.mainWorkspace.startScrollY = Blockly.mainWorkspace.scrollY)
};
...
Blockly.setCursorHand_ = function(a) {
    if (!Blockly.readOnly) {
        var b = "";
        a && (b = "url(" + Blockly.pathToBlockly + "./assets/image/hacndclosed.cur) 7 3, auto");
